...
#USER INPUTS
###############################################################################
TestDefinitionSheet=r'20240304_HOR_TESTINFO_V0.xlsx'
raw_SS_result_folder = '20240313-124146_S52512_SS'
...
input_models={
                'HighLoad':{'on':'HighLoad_genon\\HSFBESS_high_genon.sav',
                           'off':'HighLoad_genoff\\HSFBESS_high_genoff.sav'},
                'LowLoad': {'on':'LowLoad_genon\\HSFBESS_low_genon.sav',
                            'off':'LowLoad_genoff\\HSFBESS_low_genoff.sav'}}
...
def replace_placeholders(report):
    replace_dict = {'[Project Name]':str(ProjectDetailsDict['Name']), '[Project Name Short]':str(ProjectDetailsDict['NameShrt']), '[Total Plant MW at POC]': str(ProjectDetailsDict['PlantMW']), 
                    ...
                    '[State]': str(ProjectDetailsDict['State']), 
                    #'[Connection type]': str(ProjectDetailsDict['contyp']), '[POC Feeder]': str(ProjectDetailsDict['poc_fdr']),
                    '[Nominal POC voltage (kV)]': str(ProjectDetailsDict['VPOCkv']), '[PSSEversion]': str(PSSEmodelDict['PSSEversion']), 
                    #'[Lot/DP]': str(ProjectDetailsDict['lot_dp']),'[Address]': str(ProjectDetailsDict['addrs']), '[LGA]': str(ProjectDetailsDict['lga']), 
                    '[POC Substation]': str(ProjectDetailsDict['Sub']),
