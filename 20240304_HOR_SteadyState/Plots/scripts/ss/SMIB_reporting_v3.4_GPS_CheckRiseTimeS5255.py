...
#            'DMAT':{'batchname': 'Typical Cases', #in DMAT
            'DMAT':{'batchname': 'GPS S5255_Iq_Qmin', #'DMATsl_PSCAD_PSSSE_Final2', #'S5254a', #'Benchmarking', #'DMAT', #in DMAT
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20230914-0956_S5255IqQmin", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0, 
...
#
                                                            'PSSE GPS':                {
                                                                                            ...
                                                                                            'Reactive Current POC':             {'channels':[{'dataset':0, 'name':"Iq_PLANT", 'leg':'Reactive Current HV', 'offset':0.0, 'scale':1.0, 'markers':['dIq', 'rise_t', 'set_t','callout', []]},], 'unit':'p.u', 'rank':4, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0},
