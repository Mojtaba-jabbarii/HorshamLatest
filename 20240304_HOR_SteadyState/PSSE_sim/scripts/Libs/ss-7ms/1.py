...
#    psspy.tysl(0)
    ...
    while(dyr_content[index:index+1]!='\n'):
        index+=1
    new_dyr_content=dyr_content.replace(dyr_content[0:index], "1 'USRMDL' 1 'ZINGEN' 1 0 1 0 1 1 1/") #add entry for Zingen file
    os.remove(dyr_file)
...
#    psspy.set_netfrq(1) # Activate the frequency dependence
    ...
    standalone_script+="psspy.set_relang(1,1,'1')\n"
