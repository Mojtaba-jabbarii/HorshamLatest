...
!=======================================================================
      ...
      SUBROUTINE XY_profileDyn(Y, X, X1, Y1, X2, Y2, X3, Y3, X4, Y4,    &
...
! 240:[SignalTruncator]  
      CALL SignalTruncatorDyn(Y10_, Y9_, Y8_, Y7_, Y6_, Y5_, Y4_, Y3_, Y&
     &2_, Y1_, X10_, X9_, X8_, X7_, X6_, X5_, X4_, X3_, X2_, X1_, REAL(N&
     &), Y10, Y9, Y8, Y7, Y6, Y5, Y4, Y3, Y2, Y1, X10, X9, X8, X7, X6, X&
     &5, X4, X3, X2, X1)
...
!=======================================================================
      ...
      SUBROUTINE XY_profileDyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE XY_profileOut_Begin()
