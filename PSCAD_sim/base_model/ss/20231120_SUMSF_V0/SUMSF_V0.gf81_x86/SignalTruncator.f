...
!=======================================================================
      ...
      SUBROUTINE SignalTruncatorDyn(Y10_out, Y9_out, Y8_out, Y7_out,    &
     &   Y6_out, Y5_out, Y4_out, Y3_out, Y2_out, Y1_out, X10_out,       &
     &   X9_out, X8_out, X7_out, X6_out, X5_out, X4_out, X3_out,        &
     &   X2_out, X1_out, N, Y10_in, Y9_in, Y8_in, Y7_in, Y6_in, Y5_in,  &
     &   Y4_in, Y3_in, Y2_in, Y1_in, X10_in, X9_in, X8_in, X7_in,       &
     &   X6_in, X5_in, X4_in, X3_in, X2_in, X1_in)
...
!=======================================================================
      ...
      SUBROUTINE SignalTruncatorDyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE SignalTruncatorOut_Begin()
