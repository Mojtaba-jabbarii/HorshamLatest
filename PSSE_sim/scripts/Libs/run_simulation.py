...
#        standalone_script+="psspy.two_winding_chng_5("+str(DummyTxBus) +","+str(event['POC'])+",'1',[_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i],[_f,_f,_f,_f,_f, "+str(-1*event['angle'])+",_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f],[_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f],_s,_s)\n"
        ...
        if(event['model_type']=='WAUX' or event['model_type']=='WGEN'):
            ...
            standalone_script+="psspy.change_cctbusomod_var("+str(event['bus'])+", '"+str(event['model'])+"', "+str(event['rel_id']+1)+", "+str(float(event['value']))+")\n"
        else:
...
#    #psspy.two_winding_chng_5(10,2,r"""1""",[_i,_i,_i,_i,_i,_i,3,_i,_i,_i,_i,_i,_i,_i,_i],[_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f, 1.0, 1.0,_f,_f,_f,_f,_f],[_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f],_s,_s)
    ...
    if FaultBus != POC:# if Fault bus is not at POC, then it is the dummy bus
    ...
    for key in setpoint.keys():
        if ('P_' in key):
            ...
            if(loc_ID!='' and setpoint[key]!=''):#only add generator to list if an initialisation value is defined and the measurement location for initialisation is defined.
    ...
    if(tr_tap_info!={}):
        for tr in tr_tap_info.keys():
            ...
            print('intended TR adjustment: '+str(float(tr_tap_info[tr]['tap'])))
            psspy.two_winding_chng_6(tr_tap_info[tr]['from'],tr_tap_info[tr]['to'],r"""1""",[_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,_i,-1,_i,_i,_i],[_f,_f,_f,float(tr_tap_info[tr]['tap']),_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f],[_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f],_s,_s)
...
#    status, Vth, ang=initialise_loadflow(workspace_folder, ProjectDetailsDict, PSSEmodelDict, SetpointsDict[scenario_params['setpoint ID']], Vbase_POC, Vth, ANG_POC, GRID_MVA, InfiniteBus, FaultBus, DummyTxBus, POC, F_dist)# initialise load flow --> initialise, P, Q and initial voltage at POC
    status, Vth, ang=initialise_loadflow(workspace_folder, ProjectDetailsDict, PSSEmodelDict, SetpointsDict[scenario_params['setpoint ID']], Vbase_POC, Vth, ANG_POC,ang, GRID_MVA, InfiniteBus, FaultBus, DummyTxBus, POC, F_dist)# initialise load flow --> initialise, P, Q and initial voltage at POC
