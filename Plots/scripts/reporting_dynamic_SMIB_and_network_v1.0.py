...
datasets_PSSE = {'label':'PSSE_Data', 'path':r"PSSE_sim\result_data\dynamic_smib\20240731-1446_S5254_CUO", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0,#-3.0,
...
datasets_PSCAD = {'label':'PSCAD_Data', 'path':r"PSCAD_sim\result_data\dynamic_smib\20240730-0937_S5254", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0,#-3.0, 
...
datasets = [datasets_PSSE]#, datasets_PSCAD, data_PSCAD_Flatrun1, data_PSCAD_Flatrun2, data_PSCAD_Flatrun3] # [datasets_PSSE, datasets_PSCAD,datasets_nw_genon,datasets_nw_genoff]
