...
#            'DMAT':{'batchname': 'Typical Cases', #in DMAT
            'DMAT':{'batchname': 'GPS S5255_AEMO_PSSE', #'GPS S5255_AEMO_PSSE', #'GPS S5254_AEMO_PSSE', #'GPS S52514_AEMO_PSSE', #'DMATsl_PSCAD_PSSSE_Final2', #'S5254a', #'Benchmarking', #'DMAT', #in DMAT
...
#                                                    'plots_for_report': ['PSCAD Flatrun'], #PV only PSCAD
                                                    'plots_for_report': ['PSSE S5255'], #PV only PSSE
#                                                    'plots_for_report': ['PSSE S52514'], #PV only PSSE
...
#                                                                                             'Inverter State (PPC)':            {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':5},
#
#
...
#                                                                                             'Inverter State (PV)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt_1", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':9},
#                                                                                             'Inverter State (BESS)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':10},
#
#                                                                                              },
##                                                                                                                                             
...
#                                                                                            'Inverter State (PPC)':             {'channels':[{'dataset':0, 'name':"FRTACTIVE", 'leg':'PPC FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':9},
#
#                                                                                                                                                
...
#                                                                                            'Inverter State (PV)':             {'channels':[{'dataset':0, 'name':"INV1_FRT_STATE", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':8},
#                                                                                            'Inverter State (BESS)':             {'channels':[{'dataset':0, 'name':"INV2_FRT_FLAG", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':10},
#
...
#                                                                                             'Inverter State (PPC)':            {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':9},
#
#
#                                                                                             'Voltage INV':                     {'channels':[{'dataset':4, 'name':"PCU1_V_LV_pu", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
...
#                                                                                             'Inverter State (BESS)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#                                                                                             'Inverter State (PV)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt_1", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':10},
#
#                                                                                              },
#                                                                                                                                             
...
#                                                                                            'Inverter State (PPC)':             {'channels':[{'dataset':0, 'name':"FRTACTIVE", 'leg':'PPC FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':7},
#
#                                                                                                                                                
#                                                                                            'Voltage INV':                      {'channels':[{'dataset':0, 'name':"U_LV1", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
#                                                                                                                                             {'dataset':0, 'name':"U_LV2", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2, 'yminspan':0.1},                                                                                                                                                
...
#                                                                                            'Reactive Power INV':               {'channels':[{'dataset':0, 'name':"Q_LV1", 'leg':'Q_PV', 'offset':0.0, 'scale':1.0},
#                                                                                                                                             {'dataset':0, 'name':"Q_LV2", 'leg':'Q_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':6, 'yminspan':5, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                            'Inverter State (BESS)':             {'channels':[{'dataset':0, 'name':"INV2_FRT_FLAG", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#                                                                                            'Inverter State (PV)':             {'channels':[{'dataset':0, 'name':"INV1_FRT_STATE", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':10},
#
##                                                                                            'PQ CMD INV':               {'channels':[{'dataset':0, 'name':"PPV_CMD_INV", 'leg':'P_CMD_INV', 'offset':0.0, 'scale':1.0},
##                                                                                                                                     {'dataset':0, 'name':"QPV_CMD_INV", 'leg':'Q_CMD_INV', 'offset':0.0, 'scale':1.0},
##                                                                                                                                     {'dataset':0, 'name':"PPV_CMD_BESS", 'leg':'P_CMD_BESS', 'offset':0.0, 'scale':1.0},
...
##                                                                                             'Inverter State (FRT)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0},
##                                                                                                                                             {'dataset':4, 'name':"Cpu2SubStt_1", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#                                                                                              },
...
#                                                                                             'Inverter State (FRT)':            {'channels':[{'dataset':4, 'name':"LVRT_ON", 'leg':'Inverter LVRT FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#
#                                                                                             
#                                                                                              },
...
##                                                                                            'Inverter State (FRT)':             {'channels':[{'dataset':0, 'name':"INV1_VDFLAG", 'leg':'INV1 FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':4},
#                                                                                            
#                                                                                            },
...
#                                                                                             'Inverter State (FRT)':    {'channels':[{'dataset':1, 'name':"Cpu2SubStt", 'leg':'PV inverter FRT', 'offset':0.0, 'scale':1.0},
#                                                                                                                                    {'dataset':1, 'name':"BESS_VRT_FLAG", 'leg':'BESS inverter FRT', 'offset':0.0, 'scale':1.0} ], 'unit':'inverter code', 'rank':6,},
#                                                                                        },
...
#                                                                                            'Inverter State (FRT)':    {'channels':[{'dataset':0, 'name':"PV INV FRT", 'leg':'PV inverter FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':6,},
#                                                                                            },
##                                                                                            
...
#                                                                                             'Frequency':               {'channels':[{'dataset':1, 'name':"f_poi", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':5,'yminspan':5.0,},
#                                                                     #                        #'Angle':                   {'channels':[{'dataset':4, 'name':"phAngSource", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'degrees', 'rank':6, 'yminspan':10.0},
#                                                                                             'Inverter State (FRT)':    {'channels':[{'dataset':1, 'name':"BESS_VRT_FLAG", 'leg':'BESS inverter FRT', 'offset':0.0, 'scale':1.0}, ], 'unit':'inverter code', 'rank':6,},
#                                                                                              },
...
#                                                                                             'Frequency':               {'channels':[{'dataset':1, 'name':"f_poi", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':5,'yminspan':5.0,},
#                                                                     #                        #'Angle':                   {'channels':[{'dataset':4, 'name':"phAngSource", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'degrees', 'rank':6, 'yminspan':10.0},
#                                                                                             'Inverter State (FRT)':    {'channels':[{'dataset':1, 'name':"Cpu2SubStt", 'leg':'PV inverter FRT', 'offset':0.0, 'scale':1.0}, ], 'unit':'inverter code', 'rank':6,},
#                                                                                              },
#
#                                                            'PSSE DMAT PV':{                                                        
#                                                                                            'Voltage HV':                 {'channels':[{'dataset':0, 'name':"U_POC1", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0},
...
#                                                                                            'FRT flags':                   {'channels':[{'dataset':0, 'name':"INV1_VDFLAG", 'leg':'Inverter1 FRT', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                        {'dataset':0, 'name':"INV2_VDFLAG", 'leg':'Inverter2 FRT', 'offset':0.0, 'scale':1.0}], 'unit':'inverter code', 'rank':6},
...
if main_folder_path_out != main_folder_path:
    createShortcut(output_loc, main_folder_path + "\\Plots\\DMAT.lnk")
else: # if the output location is same as input location, then delete the links
    try:os.remove(main_folder_path + "\\Plots\\DMAT.lnk")
    except: pass
...
#                                        print "p_recovery period = {:2.4f}".format(p_recovery)
        #                                settling_time{"settingling period"} = settletime
                                        ...
                                        starttime=test_details['scenario_params']['time']+timeoffset_0 # starting at beggining of fault
        #                                endtime=starttime+0.8*test_details['scenario_params']['Fduration']-0.05+timeoffset_0 #leave 5 ms buffer. use as "endTime" the last 20% of the time where the fault is applied
                                        endtime=test_details['scenario_params']['time']+5+timeoffset_0 #Disturbance ended
        #                                startWindow=0.1
        #                                endWindow=1
                                        p_recovery = plot.prise(dataset_nr, subplot_info['channels'][trace_ID]['name'],100, 'U_POC1',1, distStartTime=starttime, distEndTime=endtime)
                                        p_recovery = p_recovery - endtime
