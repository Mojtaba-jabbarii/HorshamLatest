...
TestDefinitionSheet=r'20230621_SUM_TESTINFO_V1.xlsx'
"""
...
#            'DMAT':{'batchname': 'Typical Cases', #in DMAT
            'DMAT':{'batchname': 'Benchmarking', #'S5254a', #'Benchmarking', #'DMAT', #in DMAT
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20230704-2120_Benchmarking", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0, 
                                                                     ...
                                                                     {'label':'PSCAD_DMAT', 'path':r"PSCAD_sim\result_data\dynamic_smib\20230704-2057_Benchmarking", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
                                                                      'calcCurrents':[{"P":"PLANT_P_HV", "Q":"PLANT_Q_HV", "V":"PLANT_V_HV", "nameLabel":"PLANT", "scaling":0.010334129, }, 
                                                                                      {"P":"PCU1_P_LV", "Q":"PCU1_Q_LV", "V":"PCU1_V_LV", "nameLabel":"PV", "scaling":24.0, },
                                                                                       {"P":"PCU2_P_LV", "Q":"PCU2_Q_LV", "V":"PCU2_V_LV", "nameLabel":"BESS", "scaling":18.0, }],}, #inverter apaprent power rating
#                                                                        
                                                                ],
...
#                                                    'cases':['small60','small61','small62','small63','small64','small65','small66','small67','small68','small69'],
                                                    ...
                                                    'plots_for_report': ['PSCAD Results', 'PSSE Results', 'Overlays(POC)'], #PV only PSSE
...
#                                                    'plots_for_report': ['PSSE dbg'], # dbg SMA plots required
                                                    ...
                                                    'plots':{
                                                            ...
                                                            'Overlays(POC)':             {
                                                                                            'Voltage':                  {'channels':[{'dataset':4, 'name':"PLANT_V_HV", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
...
#                                                                                                                                  
                                                            'PSCAD Results':                {
                                                                                              'Voltage POC':                    {'channels':[{'dataset':4, 'name':"PLANT_V_HV", 'leg':'Voltage POC', 'offset':0.0, 'scale':1.0}, 
