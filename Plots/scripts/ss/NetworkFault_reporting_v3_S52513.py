...
#            'DMAT':{'batchname': 'S5255', #'DMAT', #in DMAT
            'NetworkFault':{'batchname': 'HighLoad_genon_S52513', #'HighLoad1', 'HighLoad2', 'HighLoad3', 'LowLoad1','LowLoad2'
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
#                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20220515_DMAT", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0}, #settling bands are added relating to the first dataset
                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_network\20230915-2150_S52513_NW\HL_dyn_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
...
#                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_network\20221029-2116_NetworkFault\HighLoad", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0, 'calcCurrents':[
#                                                                             {"P":"P_POC", "Q":"Q_POC", "V":"V_POC", "nameLabel":"PLANT", "scaling":0.010532968, }, ]},
...
#                                                    'cases':['small118','small119'], #if empty, all cases are considered
