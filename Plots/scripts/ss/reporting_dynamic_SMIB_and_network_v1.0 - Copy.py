...
# chapter_types = ["S5.2.5.5_inj", "S5.2.5.1"]
    """
#report_types = "BENCH"
#chapter_types = [] #if chapter_types == [], then include all chapters into the report
...
report_types = "GPS"
chapter_types = ["S5255"] #if chapter_types == [], then include all chapters into the report
#chapter_types = ["S5253","S5254","S52511","S52513","S52514"] #if chapter_types == [], then include all chapters into the report
...
#chapter_types = ["S52513_LowLoad", "S52513_HighLoad"] #if chapter_types == [], then include all chapters into the report
##chapter_types = ["S52512_LowLoad", "S52512_HighLoad","S52512_LowLoad", "S52512_HighLoad"] #if chapter_types == [], then include all chapters into the report
#PSSE_path_input = r"PSSE_sim\result_data\dynamic_network\Final Results GPS NEM"
#PSCAD_path_input = r"PSCAD_sim\result_data\dynamic_network\Final Results GPS SMIB"


Iq_PLANT_scl = -0.010334129 #negative due to the reversed Q measurement
Iq_PV_scl = 0.0099206
...
channels_lib = { #to be used in the ploting each graph below
                'PSCAD': {'V_POC':{'dataset':4, 'name':"PLANT_V_HV_pu", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0},
                         ...
                         'P_INV1':{'dataset':4, 'name':"PCU1_P_LV", 'leg':'P_PV', 'offset':0.0, 'scale':24.0},
                         'P_INV2':{'dataset':4, 'name':"PCU2_P_LV", 'leg':'P_BESS', 'offset':0.0, 'scale':18.0},
                         'Q_INV1':{'dataset':4, 'name':"PCU1_Q_LV", 'leg':'Q_PV', 'offset':0.0, 'scale':24.0},
                         'Q_INV2':{'dataset':4, 'name':"PCU2_Q_LV", 'leg':'Q_BESS', 'offset':0.0, 'scale':18.0},
                         'FRT_INV1':{'dataset':4, 'name':"INV1_FRT_STATE", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0},
                         'FRT_INV2':{'dataset':4, 'name':"INV2_FRT_FLAG", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0},
                         },
                'PSSE': {'V_POC':{'dataset':0, 'name':"U_POC1", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0},
                         ...
                         'F_POC':{'dataset':0, 'name':"F_POC1", 'leg':'PLANT_Freq', 'offset':0.0, 'scale':1.0},
...
datasets_PSSE = {'label':'PSSE_Data', 'path':PSSE_path_input + r"\S5255", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0,
              'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                              {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                              {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  }
datasets_PSCAD = {'label':'PSCAD_Data', 'path':PSCAD_path_input + "\S5255", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
              'calcCurrents':[{"P":"PLANT_P_HV", "Q":"PLANT_Q_HV", "V":"PLANT_V_HV_pu", "nameLabel":"PLANT", "scaling":0.010334129, }, 
                              {"P":"PCU1_P_LV", "Q":"PCU1_Q_LV", "V":"PCU1_V_LV_pu", "nameLabel":"PV", "scaling":24.0, },
                               {"P":"PCU2_P_LV", "Q":"PCU2_Q_LV", "V":"PCU2_V_LV_pu", "nameLabel":"BESS", "scaling":18.0, }],} #inverter apaprent power rating
if PSSE_path_input != '':
    datasets.append(datasets_PSSE)
if PSCAD_path_input != '':
    datasets.append(datasets_PSCAD)



print datasets
#datasets_PSSE.update({'path':'rec_t'})
dict(datasets_PSSE, **{'path':'rec_t'})
print datasets
                    ...
                    'report_definition':[          
                                           {'chapter':'S5253', #Array of chapters. 
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSCAD Results':      {
                                                                                         'Voltage POC':                    {'channels':[{'dataset':4, 'name':channels_lib["PSCAD"]["V_POC"], 'leg':'Voltage POC', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                      {'dataset':4, 'name':"PoiVolSpt_pu", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},  ], 'unit':'p.u.', 'rank':1, 'yminspan':0.01},
                                                                                         'Active Power POC':               {'channels':[{'dataset':4, 'name':"PLANT_P_HV", 'leg':'Active Power POC', 'offset':0.0, 'scale':1.0, 'markers':['rec_t']}, 
                                                                                                                                      {'dataset':4, 'name':"Pspt_MW", 'leg':'Active Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MW', 'rank':3, 'yminspan':20, 'yminlim':-200.0, 'ymaxlim':200.0}, #add active power setpoint here
                                                                                         'Reactive Power POC':             {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'Reactive Power POC', 'offset':0.0, 'scale':1.0}, 
                                           ...
                                           {'chapter':'S5254', #Array of chapters. 
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSCAD Results':      {
                                                                                         'Voltage POC':                    {'channels':[{'dataset':4, 'name':channels_lib['PSCAD']['V_POC'], 'leg':'Voltage POC', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                      {'dataset':4, 'name':channels_lib['PSCAD']['Vspt_POC'], 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},  ], 'unit':'p.u.', 'rank':1, 'yminspan':0.01},
                                                                                         'Active Power POC':               {'channels':[{'dataset':4, 'name':channels_lib['PSCAD']['P_POC'], 'leg':'Active Power POC', 'offset':0.0, 'scale':1.0, 'markers':['rec_t']}, 
                                                                                                                                      {'dataset':4, 'name':"Pspt_MW", 'leg':'Active Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MW', 'rank':3, 'yminspan':20, 'yminlim':-200.0, 'ymaxlim':200.0}, #add active power setpoint here
                                                                                         'Reactive Power POC':             {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'Reactive Power POC', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                      {'dataset':4, 'name':"Qspt_MVAr", 'leg':'Reactive Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MVAr', 'rank':5, 'yminspan':20, 'yminlim':-200.0, 'ymaxlim':200.0}, #add reactive power setpoint here
                                                                                         'Frequency':                      {'channels':[{'dataset':4, 'name':"Hz_POI", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':7, 'yminspan':5.0},
...
#
                                            ...
                                            'cases':[], #if empty, all cases are considered
                                            'plots_for_report': ['PSSE Results','PSCAD Results'],
                                            'summary_items': {}, #Additional description/analysis of the result data can bebe specified here. For example amount of current injection for 5.2.5.5 analysis in table format. Other items can be defined in the future.
                                            'report':True,
                                            'plots':{
                                                        ...
                                                        'PSSE Results':       {
                                                                                        ...
                                                                                        'Active Power INV':                 {'channels':[dict(channels_lib['PSSE']['P_INV1'], **{}),
                                                                                                                                         dict(channels_lib['PSSE']['P_INV2'], **{}),], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                        'Reactive Power INV':               {'channels':[dict(channels_lib['PSSE']['Q_INV1'], **{}),
                                                                                                                                         dict(channels_lib['PSSE']['Q_INV2'], **{}),], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                        ...
                                                        'PSCAD Results':      {
                                                                                        ...
                                                                                        'Active Power INV':                 {'channels':[dict(channels_lib['PSCAD']['P_INV1'], **{}),
                                                                                                                                         dict(channels_lib['PSCAD']['P_INV2'], **{}),], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                        'Reactive Power INV':               {'channels':[dict(channels_lib['PSCAD']['Q_INV1'], **{}),
                                                                                                                                         dict(channels_lib['PSCAD']['Q_INV2'], **{}),], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                           ...
                                           {'chapter':'S52511', #Array of chapters. 
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSSE Results':       {
                                                                                        'Voltage POC':                      {'channels':[{'dataset':0, 'name':"U_POC1", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0, 'markers':[]},
                                                                                                                                    {'dataset':0, 'name':"VREF_POC", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'p.u.', 'rank':1},
                                                                                        'Active Power POC':                 {'channels':[{'dataset':0, 'name':"P_POC1", 'leg':'P - POC', 'offset':0.0, 'scale':-1.0, 'markers':['callout', [1,6.5]]},
                                                                                                                                    {'dataset':0, 'name':"PREF_POC", 'leg':'Active Power stp', 'offset':0.0, 'scale':0.001, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'MW', 'rank':3, 'yminspan':2.0},
                                                                                        'Reactive Power POC':               {'channels':[{'dataset':0, 'name':"Q_POC1", 'leg':'Q - POC', 'offset':0.0, 'scale':-1.0},
                                                                                                                                    {'dataset':0, 'name':"QREF_POC", 'leg':'Reactive Power stp', 'offset':0.0, 'scale':0.001, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'MVAr', 'rank':5, 'yminspan':2.0},
#                                                                                        'Reactive Current POC':             {'channels':[{'dataset':0, 'name':"Iq_PLANT", 'leg':'Reactive Current HV', 'offset':0.0, 'scale':1.0, 'markers':['dIq','rise_t','set_t']},], 'unit':'p.u', 'rank':7, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0},
                                                                                        'Frequency':                        {'channels':[{'dataset':0, 'name':"F_POC1", 'leg':'Frequency', 'offset':50.0, 'scale':50.0, 'markers':['callout', [1,6.5]]},], 'unit':'Hz', 'rank':7},
                                                                                        'PPC FRT signal':                   {'channels':[{'dataset':0, 'name':"FRTACTIVE", 'leg':'PPC state', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':9},
    
                                                                                                                                            
                                                                                        'Voltage INV':                      {'channels':[{'dataset':0, 'name':"U_LV1", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"U_LV2", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2, 'yminspan':0.01},                                                                                                                                                
                                                                                        'Active Power INV':                 {'channels':[{'dataset':0, 'name':"P_LV1", 'leg':'P_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"P_LV2", 'leg':'P_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, 'yminspan':2.0},
                                                                                        'Reactive Power INV':               {'channels':[{'dataset':0, 'name':"Q_LV1", 'leg':'Q_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"Q_LV2", 'leg':'Q_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, 'yminspan':2.0},
                                                                                        'PV FRT signal':                    {'channels':[{'dataset':0, 'name':"INV1_FRT_STATE", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':8},
                                                                                        'BESS FRT signal':                  {'channels':[{'dataset':0, 'name':"INV2_FRT_FLAG", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':10},
                                                                              },

                                                        'PSCAD Results':      {
                                                                                         'Voltage POC':                    {'channels':[{'dataset':4, 'name':"PLANT_V_HV_pu", 'leg':'Voltage POC', 'offset':0.0, 'scale':1.0, 'markers':[]}, 
                                                                                                                                      {'dataset':4, 'name':"PoiVolSpt_pu", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},  ], 'unit':'p.u.', 'rank':1, 'yminspan':0.05},
                                                                                         'Active Power POC':               {'channels':[{'dataset':4, 'name':"PLANT_P_HV", 'leg':'Active Power POC', 'offset':0.0, 'scale':1.0, 'markers':['callout', [1,6.5]]}, 
                                                                                                                                      {'dataset':4, 'name':"Pspt_MW", 'leg':'Active Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MW', 'rank':3, 'yminspan':2.0, 'yminlim':-200.0, 'ymaxlim':200.0}, #add active power setpoint here
                                                                                         'Reactive Power POC':             {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'Reactive Power POC', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                      {'dataset':4, 'name':"Qspt_MVAr", 'leg':'Reactive Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MVAr', 'rank':5, 'yminspan':2.0, 'yminlim':-200.0, 'ymaxlim':200.0}, #add reactive power setpoint here
                                                                                         'Frequency':                      {'channels':[{'dataset':4, 'name':"Hz_POI", 'leg':'Frequency', 'offset':0.0, 'scale':1.0, 'markers':['callout', [1,6.5]]},], 'unit':'Hz', 'rank':7, 'yminspan':5.0},
#                                                                                         'Reactive Current POC':           {'channels':[{'dataset':4, 'name':"Iq_PLANT", 'leg':'Reactive Current POC', 'offset':0.0, 'scale':1.0, 'markers':['dIq','rise_t','set_t']},], 'unit':'p.u', 'rank':7, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0 },
                                                                                         'PPC FRT signal':                 {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC state', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':9},


                                                                                         'Voltage INV':                    {'channels':[{'dataset':4, 'name':"PCU1_V_LV_pu", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':4, 'name':"PCU2_V_LV_pu", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2, 'yminspan':0.01},
                                                                                         'Active Power INV':               {'channels':[{'dataset':4, 'name':"PCU1_P_LV", 'leg':'P_PV', 'offset':0.0, 'scale':24.0},
                                                                                                                                         {'dataset':4, 'name':"PCU2_P_LV", 'leg':'P_BESS', 'offset':0.0, 'scale':18.0},], 'unit':'MW', 'rank':4, 'yminspan':10, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                         'Reactive Power INV':             {'channels':[{'dataset':4, 'name':"PCU1_Q_LV", 'leg':'Q_PV', 'offset':0.0, 'scale':24.0},
                                                                                                                                         {'dataset':4, 'name':"PCU2_Q_LV", 'leg':'Q_BESS', 'offset':0.0, 'scale':18.0},], 'unit':'MVAr', 'rank':6, 'yminspan':10, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                         'PV FRT signal':                  {'channels':[{'dataset':4, 'name':"FRT_flag_PV", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
                                                                                         'BESS FRT signal':                {'channels':[{'dataset':4, 'name':"FRT_flag_BESS", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':10},
                                                                                },

                                                        'Overlays':             {
                                                                                        'Voltage':                  {'channels':[{'dataset':4, 'name':"PLANT_V_HV_pu", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                 {'dataset':0, 'name':"U_POC1", 'leg':'PSSE', 'offset':0.0, 'scale':1.0, 'markers':['GSMG']}], 'unit':'p.u.', 'rank':1},#'GSMG':0, }, #first channel in array links to file in first result location
                                                                                        'Active Power':             {'channels':[{'dataset':4, 'name':"PLANT_P_HV", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                {'dataset':0, 'name':"P_POC1", 'leg':'PSSE', 'offset':0.0, 'scale':-1.0, 'markers':['GSMG']}], 'unit':'MW', 'rank':2, 'yminlim':-200.0, 'ymaxlim':200.0},#'GSMG':0},
                                                                                        'Reactive Power':           {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
                                                                                                                                {'dataset':0, 'name':"Q_POC1", 'leg':'PSSE', 'offset':0.0, 'scale':-1.0, 'markers':['GSMG']}], 'unit':'MVAr', 'rank':3, 'yminlim':-200.0, 'ymaxlim':200.0},  
                                                                                },
                                           ...
                                           {'chapter':'S52513', #Array of chapters. 
                                            'datasets': [
                                                         ...
                                                         {'label':'PSCAD_Data', 'path':PSCAD_path_input + "\S52513", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
                                                          ...
                                                          'calPFs':[{"P":"PLANT_P_HV", "Q":"PLANT_Q_HV", "nameLabel":"PLANT", "scaling":1.0, } ],
                                                         }, #inverter apaprent power rating
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSSE Results':       {
                                                                                        'Voltage POC':                      {'channels':[{'dataset':0, 'name':"U_POC1", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0, 'markers':["rise_t","set_t",'callout', [7]]},
                                                                                                                                    {'dataset':0, 'name':"VREF_POC", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5, 'markers':['callout', [7]]},], 'unit':'p.u.', 'rank':1},
                                                                                        'Active Power POC':                 {'channels':[{'dataset':0, 'name':"P_POC1", 'leg':'P - POC', 'offset':0.0, 'scale':-1.0, 'markers':[]},
                                                                                                                                    {'dataset':0, 'name':"PREF_POC", 'leg':'Active Power stp', 'offset':0.0, 'scale':0.001, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'MW', 'rank':3, 'yminspan':2},
                                                                                        'Reactive Power POC':               {'channels':[{'dataset':0, 'name':"Q_POC1", 'leg':'Q - POC', 'offset':0.0, 'scale':-1.0, 'markers':["rise_t","set_t",'callout', [7]]},
                                                                                                                                    {'dataset':0, 'name':"QREF_POC", 'leg':'Reactive Power stp', 'offset':0.0, 'scale':0.001, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'MVAr', 'rank':5, 'yminspan':2},
#                                                                                        'Frequency':                        {'channels':[{'dataset':0, 'name':"F_POC1", 'leg':'Frequency', 'offset':50.0, 'scale':50.0},], 'unit':'Hz', 'rank':7, 'yminspan':5.0},
                                                                                        'Powerfactor POC':                  {'channels':[{'dataset':0, 'name':"PF_PLANT", 'leg':'Powerfactor', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"PFREF", 'leg':'PF stp', 'offset':1.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'pu', 'rank':7},
                                                                                        'PPC FRT signal':                   {'channels':[{'dataset':0, 'name':"FRTACTIVE", 'leg':'PPC FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':9},
    
                                                                                                                                            
                                                                                        'Voltage INV':                      {'channels':[{'dataset':0, 'name':"U_LV1", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"U_LV2", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2, 'yminspan':0.01},                                                                                                                                                
                                                                                        'Active Power INV':                 {'channels':[{'dataset':0, 'name':"P_LV1", 'leg':'P_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"P_LV2", 'leg':'P_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                                                                         {'dataset':0, 'name':"P_LV2", 'leg':'P_BESS', 'offset':0.0, 'scale':1.0},
#                                                                                                                                         {'dataset':0, 'name':"PREF_BESS", 'leg':'P_BESS stp', 'offset':0.0, 'scale':0.001, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'MW', 'rank':4, 'yminspan':1, 'ymaxlim':200.0, 'yminlim':-200.0, },

                                                                                        'Reactive Power INV':               {'channels':[{'dataset':0, 'name':"Q_LV1", 'leg':'Q_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':0, 'name':"Q_LV2", 'leg':'Q_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                        'PV FRT signal':                    {'channels':[{'dataset':0, 'name':"INV1_FRT_STATE", 'leg':'PV FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':8},
                                                                                        'BESS FRT signal':                  {'channels':[{'dataset':0, 'name':"INV2_FRT_FLAG", 'leg':'BESS FRT', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':10},
                                                                              },

                                                        'PSCAD Results':      {
                                                                                         'Voltage POC':                    {'channels':[{'dataset':4, 'name':"PLANT_V_HV_pu", 'leg':'Voltage POC', 'offset':0.0, 'scale':1.0, 'markers':["rise_t","set_t",'callout', [8]]}, 
                                                                                                                                      {'dataset':4, 'name':"PoiVolSpt_pu", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5, 'markers':['callout', [8]]},  ], 'unit':'p.u.', 'rank':1},
                                                                                         'Active Power POC':               {'channels':[{'dataset':4, 'name':"PLANT_P_HV", 'leg':'Active Power POC', 'offset':0.0, 'scale':1.0, 'markers':[]}, 
                                                                                                                                      {'dataset':4, 'name':"Pspt_MW", 'leg':'Active Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MW', 'rank':3, 'yminlim':-200.0, 'ymaxlim':200.0}, #add active power setpoint here
                                                                                         'Reactive Power POC':             {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'Reactive Power POC', 'offset':0.0, 'scale':1.0, 'markers':["rise_t","set_t",'callout', [8]]}, 
                                                                                                                                      {'dataset':4, 'name':"Qspt_MVAr", 'leg':'Reactive Power stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}, ], 'unit':'MVAr', 'rank':5, 'yminlim':-200.0, 'ymaxlim':200.0}, #add reactive power setpoint here
#                                                                                         'Frequency':                      {'channels':[{'dataset':4, 'name':"Hz_POI", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':7, 'yminspan':5.0},
                                                                                         'Powerfactor POC':                {'channels':[{'dataset':4, 'name':"PF_PLANT", 'leg':'Powerfactor', 'offset':0.0, 'scale':1.0},
                                                                                                                                         {'dataset':4, 'name':"PoiPfSpt", 'leg':'PF stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'pu', 'rank':7},
                                                                                         'PPC FRT signal':                 {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC state', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':9},
...
#####################################################
            'NetworkEvent':{ # in network contingency events
                    ...
                    'report_definition':[          
                                           {'chapter':'S5255_HighLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_Data', 'path':PSSE_path_input +r"\5255_HL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
    ...
    #                                                                                            'Angle':                           {'channels':[{'dataset':0, 'name':"ANG_POC1", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':7, 'yminspan':10.0},
                                           ...
                                           {'chapter':'S5255_LowLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_Network', 'path':PSSE_path_input + r"\5255_LL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
    ...
    #                                                                                            'Angle':                           {'channels':[{'dataset':0, 'name':"ANG_POC1", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':7, 'yminspan':10.0},
                                           ...
                                           {'chapter':'S52512_HighLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_genon', 'path':PSSE_path_input +r"\52512_HL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },

                                                         {'label':'PSSE_genoff', 'path':PSSE_path_input +r"\52512_HL_genoff", 'ID': 1, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
...
#                                                        'PSSE S52512 network':  {
#                                                                                        'Voltage':                  {'channels':[{'dataset':4, 'name':"U_POC1", 'leg':'Before SUMSF', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                 {'dataset':0, 'name':"U_POC1", 'leg':'After SUMSF', 'offset':0.0, 'scale':1.0, 'markers':[]}], 'unit':'p.u.', 'rank':1, 'yminspan':0.1},#'GSMG':0, }, #first channel in array links to file in first result location
#                                                                                        'Active Power':             {'channels':[{'dataset':4, 'name':"U_POC1", 'leg':'Before SUMSF', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                {'dataset':0, 'name':"P_POC1", 'leg':'After SUMSF', 'offset':0.0, 'scale':-1.0, 'markers':[]}], 'unit':'MW', 'rank':2, 'yminspan':50, 'yminlim':-200.0, 'ymaxlim':200.0},#'GSMG':0},
#                                                                                        'Reactive Power':           {'channels':[{'dataset':4, 'name':"U_POC1", 'leg':'Before SUMSF', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                {'dataset':0, 'name':"Q_POC1", 'leg':'After SUMSF', 'offset':0.0, 'scale':-1.0, 'markers':[]}], 'unit':'MVAr', 'rank':3, 'yminspan':10.0, 'yminlim':-200.0, 'ymaxlim':200.0},  
#                                                                                },
...
#                                                                                                                                     {'dataset':0, 'name':"V_SUM_POC", 'leg':'post-SUMSF', 'offset':0.0, 'scale':1.0}], 'unit':'p.u.', 'rank':4, 'yminspan':0.1, 'ymaxlim':1.4},#'GSMG':0, }, #first channel in array links to file in first result location                                                                                                                                       
                                           ...
                                           {'chapter':'S52512_LowLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_genon', 'path':PSSE_path_input +r"\52512_LL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },

                                                         {'label':'PSSE_genoff', 'path':PSSE_path_input +r"\52512_LL_genoff", 'ID': 1, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
...
#                                                                                                                                     {'dataset':0, 'name':"V_SUM_POC", 'leg':'post-SUMSF', 'offset':0.0, 'scale':1.0}], 'unit':'p.u.', 'rank':4, 'yminspan':0.1, 'ymaxlim':1.4},#'GSMG':0, }, #first channel in array links to file in first result location                                                                                                                                       
                                           ...
                                           {'chapter':'S52513_HighLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_Data', 'path':PSSE_path_input +r"\52513_HL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
    ...
    #                                                                                            'Angle':                           {'channels':[{'dataset':0, 'name':"ANG_POC1", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':7, 'yminspan':10.0},
                                           ...
                                           {'chapter':'S52513_LowLoad', #Array of chapters. 
                                            'datasets': [
                                                         {'label':'PSSE_Network', 'path':PSSE_path_input + r"\52513_LL_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
                                                          'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                                                                          {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                                                                          {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  },
                                                        ],
...
#            headers=['Case Nr.', 'Test Type', 'Test profile', 'POC voltage', 'Grid SCR', 'Grid X/R', 'P at POC (MW)', 'Q at POC (MVAr)', 'PSSE time step (ms)', 'PSSE acc. factor', 'DMAT id', 'passed']
        headers=['Case Nr.', 'Test Type', 'Test profile', 'POC voltage', 'Grid SCR', 'Grid X/R', 'P at POC (MW)', 'Q at POC (MVAr)', 'Control mode', 'passed']
        table=report.add_table(rows=1, cols=len(headers))
        table.style='ListTable3-Accent3'
        hdr_cells=table.rows[0].cells
        for header_id in range(0, len(headers)): hdr_cells[header_id].text=headers[header_id]
...
#                    row_cells[4].text=str(test_details['setpoint']['SCR'])
                ...
                row_cells[6].text=str(test_details['setpoint']['P'])
                row_cells[7].text=str(test_details['setpoint']['Q'])
                row_cells[8].text=str(test_details['scenario_params']['test group'])
    ...
    if(any('large' in case for case in cases)):
        p.add_run('Table '+str(tableCnt)+': Scenario list - Large Disturbance tests').bold=True  
        headers=['Case Nr.', 'Test Type', 'Fault Type', 'Fault time', 'Fault duration', 'Fault impedance', 'V residual', 'Fault X/R', 'POC voltage', 'Grid SCR', 'Grid X/R', 'Grid SCR post-fault','Grid X/R post-fault', 'P at POC (MW)', 'Q at POC (MVAr)', 'Control mode','passed']
        table1=report.add_table(rows=1, cols=len(headers))
        table1.style='ListTable3-Accent3'
        hdr_cells1=table1.rows[0].cells
        for header_id in range(0, len(headers)): hdr_cells1[header_id].text=headers[header_id]
...
#                        row_cells[11].text=str(test_details['setpoint']['GridMVA'])
                ...
                row_cells[13].text=str(test_details['setpoint']['P'])
                row_cells[14].text=str(test_details['setpoint']['Q'])
                row_cells[15].text=str(test_details['scenario_params']['test group'])
    ...
    if(any('ort' in case for case in cases)):
        p.add_run('Table '+str(tableCnt)+': Scenario list - Oscillatory Rejection tests').bold=True        
        headers=['Case Nr.', 'Test Type', 'Time', 'Disturbance Frequency', 'Disturbance Magnitude', 'Phase Oscillation Magnitude', 'POC voltage', 'Grid SCR', 'Grid X/R',  'P at POC (MW)', 'Q at POC (MVAr)', 'Control mode', 'passed']
        table1=report.add_table(rows=1, cols=len(headers))
        table1.style='ListTable3-Accent3'
        hdr_cells1=table1.rows[0].cells
        for header_id in range(0, len(headers)): hdr_cells1[header_id].text=headers[header_id]
...
#                    row_cells[7].text=str(test_details['setpoint']['GridMVA'])
                ...
                row_cells[9].text=str(test_details['setpoint']['P'])
                row_cells[10].text=str(test_details['setpoint']['Q'])
                row_cells[11].text=str(test_details['scenario_params']['test group'])
    ...
    if(any('tov' in case for case in cases)):
        p.add_run('Table '+str(tableCnt)+': Scenario list - Temporary Over-Voltage tests').bold=True        
        headers=['Case Nr.', 'Test Type', 'Time', 'TOV duration', 'Capacity(F)', 'V residual', 'POC voltage', 'Grid SCR', 'Grid X/R', 'Grid SCR post-TOV','Grid X/R post-TOV', 'P at POC (MW)', 'Q at POC (MVAr)', 'Control mode', 'passed']
        table1=report.add_table(rows=1, cols=len(headers))
        table1.style='ListTable3-Accent3'
        hdr_cells1=table1.rows[0].cells
        for header_id in range(0, len(headers)): hdr_cells1[header_id].text=headers[header_id]
...
#                        row_cells[9].text=str(test_details['setpoint']['GridMVA'])
                ...
                row_cells[11].text=str(test_details['setpoint']['P'])
                row_cells[12].text=str(test_details['setpoint']['Q'])
                row_cells[13].text=str(test_details['scenario_params']['test group'])
...
#        row_cells[1].text=str(test_details['setpoint']['GridMVA'])
        ...
        row_cells[3].text=str(test_details['setpoint']['Q'])
        row_cells=table.add_row().cells
