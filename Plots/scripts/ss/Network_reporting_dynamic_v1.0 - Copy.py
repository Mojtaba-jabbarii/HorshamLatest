...
#            'DMAT':{'batchname': 'S5255', #'DMAT', #in DMAT
            'NetworkEvent':{'batchname': 'HighLoad_genon', #'HighLoad1', 'HighLoad2', 'HighLoad3', 'LowLoad1','LowLoad2'
...
#                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20220515_DMAT", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0}, #settling bands are added relating to the first dataset
                                                                     {'label':'PSSE_Network', 'path':r"PSSE_sim\result_data\dynamic_network\20240207-2330_S5255_NW\HighLoad_genon", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
