...
#            'DMAT':{'batchname': 'Typical Cases', #in DMAT
            'DMAT':{'batchname': 'GPS S5253', #'DMATsl_PSCAD_PSSSE_Final2', #'S5254a', #'Benchmarking', #'DMAT', #in DMAT
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20231120-1846_S5253", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0, 
...
#                                                                     {'label':'PSCAD_DMAT', 'path':r"PSCAD_sim\result_data\dynamic_smib\20231120-1846_S5253", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-5.0, 
