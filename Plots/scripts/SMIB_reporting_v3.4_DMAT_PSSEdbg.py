...
#            'DMAT':{'batchname': 'Typical Cases', #in DMAT
            'DMAT':{'batchname': 'DMATsl6_PSSE', #'S5254a', #'Benchmarking', #'DMAT', #in DMAT
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20230908-1705_DMATsl6", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0, 
...
#                                                                     {'label':'PSCAD_DMAT', 'path':r"PSCAD_sim\result_data\dynamic_smib\20230331-2243_DMATsl", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
#                                                                      'calcCurrents':[{"P":"PLANT_P_HV", "Q":"PLANT_Q_HV", "V":"PLANT_V_HV", "nameLabel":"PLANT", "scaling":0.010334129, }, 
#                                                                                      {"P":"PCU1_P_LV", "Q":"PCU1_Q_LV", "V":"PCU1_V_LV", "nameLabel":"PV", "scaling":1, },
#                                                                                       {"P":"PCU2_P_LV", "Q":"PCU2_Q_LV", "V":"PCU2_V_LV", "nameLabel":"BESS", "scaling":1, }],}, #inverter apaprent power rating
#                                                                        
                                                                ],
...
#                                                    'plots_for_report': ['PSCAD DMAT', 'PSSE DMAT', 'Overlays(POC)', 'Overlays(INV)'], #PV only PSSE
...
#                                                            'PSCAD dbg POC':                {
#                                                                                              'Voltage POC':                    {'channels':[{'dataset':4, 'name':"PLANT_V_HV", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                          {'dataset':4, 'name':"PoiVolSpt_pu", 'leg':'Voltage stp', 'offset':0.0, 'scale':1.0, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},  ], 'unit':'p.u.', 'rank':1},
#                                                                                              'Active Power POC':               {'channels':[{'dataset':4, 'name':"PLANT_P_HV", 'leg':'Active Power HV', 'offset':0.0, 'scale':1.0}, 
...
#                                                                                              'Reactive Power POC':             {'channels':[{'dataset':4, 'name':"PLANT_Q_HV", 'leg':'Reactive Power HV', 'offset':0.0, 'scale':1.0}, 
...
#                                                                                                                                          {'dataset':4, 'name':"AmpPsQSpt", 'leg':'Iq_PV stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},
#                                                                                                                                              {'dataset':4, 'name':"AmpPsQ_1", 'leg':'Iq_BESS', 'offset':0.0, 'scale':1.0}, 
#                                                                                                                                          {'dataset':4, 'name':"AmpPsQSpt_1", 'leg':'Iq_BESS stp', 'offset':0.0, 'scale':1, 'colour':'grey', 'linestyle':'--', 'linewidth': 1.5},], 'unit':'p.u.', 'rank':3, 'yminlim':-200.0, 'ymaxlim':200.0}, #add active power setpoint here
...
##                                                                                             'Angle':                           {'channels':[{'dataset':4, 'name':"phAngSource", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'degrees', 'rank':7, 'yminspan':10.0},
#
#                                                                                             'Voltage INV':                     {'channels':[{'dataset':4, 'name':"PCU1_V_LV", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.5873015873},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_V_LV", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.5873015873},], 'unit':'p.u.', 'rank':2, 'yminspan':0.1},
#                                                                                             'Active Power INV':                {'channels':[{'dataset':4, 'name':"PCU1_P_LV", 'leg':'P_PV', 'offset':0.0, 'scale':26.0},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_P_LV", 'leg':'P_BESS', 'offset':0.0, 'scale':36.0},], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                             'Reactive Power INV':              {'channels':[{'dataset':4, 'name':"PCU1_Q_LV", 'leg':'Q_PV', 'offset':0.0, 'scale':26.0},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_Q_LV", 'leg':'Q_BESS', 'offset':0.0, 'scale':36.0},], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, },
...
#                                                            'PSSE dbg INV2':                {
#                                                                                            'Active Current INV':               {'channels':[{'dataset':0, 'name':"Iq_PLANT", 'leg':'Iq', 'offset':0.0, 'scale':1.0},
#                                                                                                                                        {'dataset':0, 'name':"INV1_IQ_COMMAND", 'leg':'Iq_cmd', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':1},
#                                                                                            'Reactive Current INV':             {'channels':[{'dataset':0, 'name':"INV1_IP_COMMAND", 'leg':'Id', 'offset':0.0, 'scale':1.0},
#                                                                                                                                        {'dataset':0, 'name':"INV1_IP_COMMAND", 'leg':'Id', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':3, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                            'Vd/Vq':                            {'channels':[{'dataset':0, 'name':"INV1_IP_COMMAND", 'leg':'Id', 'offset':0.0, 'scale':1.0},
#                                                                                                                                        {'dataset':0, 'name':"INV1_IP_COMMAND", 'leg':'Id', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':5, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                            'Frequency':                        {'channels':[{'dataset':0, 'name':"F_POC1", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':7, 'ymaxlim':2.0, 'yminlim':-2.0},
##                                                                                            'Frequency':                        {'channels':[{'dataset':0, 'name':"F_POC1", 'leg':'Frequency', 'offset':50.0, 'scale':50.0},], 'unit':'Hz', 'rank':7, 'yminspan':5.0},
##                                                                                            'Angle':                           {'channels':[{'dataset':0, 'name':"ANG_POC1", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':7, 'yminspan':10.0},
#
#                                                                                                                                                
#                                                                                            'Voltage INV':                      {'channels':[{'dataset':0, 'name':"U_LV1", 'leg':'Voltage INV1', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2},                                                                                                                                                
#                                                                                            'Active Power INV':                 {'channels':[{'dataset':0, 'name':"P_LV1", 'leg':'P_INV1', 'offset':0.0, 'scale':1.0},], 'unit':'MW', 'rank':4, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                            'Reactive Power INV':               {'channels':[{'dataset':0, 'name':"Q_LV1", 'leg':'Q_INV1', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':6, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                            'Inverter State (FRT)':             {'channels':[{'dataset':0, 'name':"INV1_LVRT", 'leg':'INV1 LVRT', 'offset':0.0, 'scale':1.0},
#                                                                                                                                            {'dataset':0, 'name':"INV1_HVRT", 'leg':'INV1 HVRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#                                                                                            },
...
#                                                                                                                                     
#                                                            'Overlays(INV)':             {
#                                                                                        'Voltage':                  {'channels':[{'dataset':4, 'name':"Vrms_LV_inv1_pu", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
...
#                                                                                                                                {'dataset':0, 'name':"P_LV1", 'leg':'PSSE', 'offset':0.0, 'scale':1.0, 'markers':['GSMG']}], 'unit':'MW', 'rank':2, 'yminspan':50, 'yminlim':-200.0, 'ymaxlim':200.0},#'GSMG':0},
##                                                                                        'Reactive Power':           {'channels':[{'dataset':4, 'name':"Qout_LV (MVar)", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
##                                                                                                                                {'dataset':0, 'name':"Q_LV1", 'leg':'PSSE', 'offset':0.0, 'scale':1.0, 'markers':['GSMG']}], 'unit':'MVAr', 'rank':3, 'yminspan':10.0, 'yminlim':-200.0, 'ymaxlim':200.0},  
##                                                                                            'Voltage Low':              {'channels':[{'dataset':4, 'name':"Vrms_LV_inv1_pu", 'leg':'PSCAD', 'offset':0.0, 'scale':1.0}, 
##                                                                                                                                     {'dataset':0, 'name':"U_LV1", 'leg':'PSSE', 'offset':0.0, 'scale':1.0}], 'unit':'p.u.', 'rank':4, 'yminspan':0.1, 'ymaxlim':1.3},#'GSMG':0, }, #first channel in array links to file in first result location
...
#                                                                                                                                             {'dataset':4, 'name':"PCU2_V_LV", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.5873015873},], 'unit':'p.u.', 'rank':2, 'yminspan':0.1},
#                                                                                             'Active Power INV':                {'channels':[{'dataset':4, 'name':"PCU1_P_LV", 'leg':'P_PV', 'offset':0.0, 'scale':26.0},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_P_LV", 'leg':'P_BESS', 'offset':0.0, 'scale':36.0},], 'unit':'MW', 'rank':4, 'yminspan':10, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                             'Reactive Power INV':              {'channels':[{'dataset':4, 'name':"PCU1_Q_LV", 'leg':'Q_PV', 'offset':0.0, 'scale':26.0},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_Q_LV", 'leg':'Q_BESS', 'offset':0.0, 'scale':36.0},], 'unit':'MVAr', 'rank':6, 'yminspan':10, 'ymaxlim':200.0, 'yminlim':-200.0, },
#                                                                                             'Inverter State (FRT)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt", 'leg':'PV state', 'offset':0.0, 'scale':1.0},
#                                                                                                                                             {'dataset':4, 'name':"Cpu2SubStt_1", 'leg':'BESS state', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
#
#                                                                                              },
...
#                                                                                            'Inverter State (FRT)':             {'channels':[{'dataset':0, 'name':"INV1_LVRT", 'leg':'INV1_FRT_FLAG', 'offset':0.0, 'scale':1.0},
#                                                                                                                                            {'dataset':0, 'name':"INV1_HVRT", 'leg':'INV1 HVRT', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':8},
                                                                                            'PQ CMD INV':               {'channels':[{'dataset':0, 'name':"P_CMD_PV", 'leg':'P_CMD_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                     {'dataset':0, 'name':"Q_CMD_PV", 'leg':'Q_CMD_PV', 'offset':0.0, 'scale':1.0},
                                                                                                                                     {'dataset':0, 'name':"P_CMD_BESS", 'leg':'P_CMD_BESS', 'offset':0.0, 'scale':1.0},
                                                                                                                                     {'dataset':0, 'name':"Q_CMD_BESS", 'leg':'Q_CMD_BESS', 'offset':0.0, 'scale':1.0},], 'unit':'MVAr', 'rank':8, 'ymaxlim':200.0, 'yminlim':-200.0, },
                                                                                            },
#                                                                                                                                             
#                                                            'PSSE S5253':                {
#                                                                                            'Voltage POC':                      {'channels':[{'dataset':0, 'name':"U_POC1", 'leg':'Voltage HV', 'offset':0.0, 'scale':1.0},
