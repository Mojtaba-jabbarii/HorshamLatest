...
report_types = "GPS"
chapter_types = ["S52513"] #if chapter_types == [], then include all chapters into the report
#chapter_types = ["S5253","S5254","S52511","S52513","S52514"] #if chapter_types == [], then include all chapters into the report
datasets_1_path = r"PSSE_sim\result_data\dynamic_smib\Final Results GPS SMIB"
...
datasets = []
datasets_1 = {'label':'PSSE_Data', 'path':datasets_1_path, 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0,
...
datasets_2 = {'label':'PSCAD_Data', 'path':datasets_2_path, 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
...
"""
datasets_1 = {'label':'PSSE_genon', 'path':PSSE_path_input, 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-2.0,
              'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                              {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                              {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  }

datasets_2 = {'label':'PSSE_genoff', 'path':PSSE_path_input, 'ID': 1, 'timeID':'Time(s)', 'timeoffset':-2.0,
              'calcCurrents':[{"P":"P_POC1", "Q":"Q_POC1", "V":"U_POC1", "nameLabel":"PLANT", "scaling":Iq_PLANT_scl, }, # 1/Sbase_POC for Iq at POC or 1/Sbase_INV for Iq at INV -> convert QMVAr to Qpu for calculation
                              {"P":"P_LV1", "Q":"Q_LV1", "V":"U_LV1", "nameLabel":"PV", "scaling":Iq_PV_scl, },
                              {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":Iq_BESS_scl, },]  }
"""
...
if datasets_1_path != '':
    datasets.append(datasets_1)
if datasets_2_path != '':
    datasets.append(datasets_2)
...
channels_lib = { #to be used in the ploting each graph below
                ...
                'NW_pre':   {'V_POC':{'dataset':0, 'name':"U_POC1", 'leg':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Lismore330':{'dataset':0, 'name':"V_LSM_330", 'leg':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Coffs_Harbour330':{'dataset':0, 'name':"V_COFF_330", 'leg':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Lismore132':{'dataset':0, 'name':"V_LSM_132", 'leg':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Koolkhan132':{'dataset':0, 'name':"V_KOLK_132", 'leg':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             },
                'NW_post':  {'V_POC':{'dataset':1, 'name':"U_POC1", 'leg':'after-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Lismore330':{'dataset':1, 'name':"V_LSM_330", 'leg':'after-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Coffs_Harbour330':{'dataset':1, 'name':"V_COFF_330", 'after':'pre-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Lismore132':{'dataset':1, 'name':"V_LSM_132", 'leg':'after-SUMSF', 'offset':0.0, 'scale':1.0},
                             'Koolkhan132':{'dataset':1, 'name':"V_KOLK_132", 'leg':'after-SUMSF', 'offset':0.0, 'scale':1.0},
                             },
                }
                                           ...
                                           {'chapter':'S52511', #Array of chapters. 
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSSE Results':       {
                                                                                        ...
                                                                                        'Reactive Power POC':               {'channels':[dict(channels_lib['PSSE']['Q_POC'], **{'markers':[]}),
                                                                                                                                         dict(channels_lib['PSSE']['Qspt_POC'], **{'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}),], 'unit':'MVAr', 'rank':5},
                                                                                        'Frequency':                        {'channels':[dict(channels_lib['PSSE']['F_POC'], **{'markers':['callout', [1,6.5]]})], 'unit':'p.u', 'rank':7, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0},
                                                        ...
                                                        'PSCAD Results':      {
                                                                                        ...
                                                                                        'Reactive Power POC':               {'channels':[dict(channels_lib['PSCAD']['Q_POC'], **{}),
                                                                                                                                         dict(channels_lib['PSCAD']['Qspt_POC'], **{'colour':'grey', 'linestyle':'--', 'linewidth': 1.5}),], 'unit':'MVAr', 'rank':5},
                                                                                        'Frequency':                        {'channels':[dict(channels_lib['PSCAD']['F_POC'], **{'markers':['callout', [1,6.5]]})], 'unit':'p.u', 'rank':7, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0},
            ...
            'NetworkEvent':{ # in network contingency events
                    ...
                    'report_definition':[          
                                           ...
                                           {'chapter':'S5255_HighLoad', #Array of chapters. 
                                            'datasets': [ dict(datasets[did], **{'path':datasets[did]['path']+r'\5255_HL_genon'}) for did in range(len(datasets))], # update the dataset path to the chapter result location
                                            'cases':[], #if empty, all cases are considered
                                           ...
                                           {'chapter':'S5255_LowLoad', #Array of chapters. 
                                            'datasets': [ dict(datasets[did], **{'path':datasets[did]['path']+r'\5255_LL_genon'}) for did in range(len(datasets))], # update the dataset path to the chapter result location
                                            'cases':[], #if empty, all cases are considered
                                            'plots_for_report': ['PSSE S5255 network'],
                                            'summary_items': {}, #Additional description/analysis of the result data can bebe specified here. For example amount of current injection for 5.2.5.5 analysis in table format. Other items can be defined in the future.
                                            'report':True,
                                           ...
                                           {'chapter':'S52512_HighLoad', #Array of chapters. 
                                            'datasets': [ dict(datasets[did], **{'path':datasets[did]['path']+r'\52512_HL'}) for did in range(len(datasets))], # update the dataset path to the chapter result location
                                            'cases':[], #if empty, all cases are considered
                                            ...
                                            'plots':{
                                                        ...
                                                        'PSSE S52512 network':       {
                                                                                        ...
                                                                                        'Lismore 330kV bus voltage':        {'channels':[dict(channels_lib['NW_pre']['Lismore330'], **{}),
                                                                                                                                         dict(channels_lib['NW_post']['Lismore330'], **{}),], 'unit':'p.u.', 'rank':1, 'yminspan':0.1, 'ymaxlim':1.4, 'xmaxlim':3},
                                                                                        'Coffs Harbour 330kV bus voltage':  {'channels':[dict(channels_lib['NW_pre']['Coffs_Harbour330'], **{}),
                                                                                                                                         dict(channels_lib['NW_post']['Coffs_Harbour330'], **{}),], 'unit':'p.u.', 'rank':1, 'yminspan':0.1, 'ymaxlim':1.4, 'xmaxlim':3},
                                                                                        'Lismore 132kV bus voltage':        {'channels':[dict(channels_lib['NW_pre']['Lismore132'], **{}),
                                                                                                                                         dict(channels_lib['NW_post']['Lismore132'], **{}),], 'unit':'p.u.', 'rank':1, 'yminspan':0.1, 'ymaxlim':1.4, 'xmaxlim':3},
                                                                                        'Koolkhan 132kV bus voltage':       {'channels':[dict(channels_lib['NW_pre']['Koolkhan132'], **{}),
                                                                                                                                         dict(channels_lib['NW_post']['Koolkhan132'], **{}),], 'unit':'p.u.', 'rank':1, 'yminspan':0.1, 'ymaxlim':1.4, 'xmaxlim':3},
