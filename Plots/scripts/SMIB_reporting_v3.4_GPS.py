...
#            'DMAT':{'batchname': 'GPS Clauses', #in GPS Compliance Report
                    'report_definition':[          {'chapter':'general', #Array of chapters. In this case there is only one chapter.
                                                    'datasets': [
#                                                                     {'label':'PSSE_DMAT', 'path':r"PSSE_sim\result_data\dynamic_smib\20230914-0956_S52516", 'ID': 0, 'timeID':'Time(s)', 'timeoffset':-3.0, 
...
#                                                                                      {"P":"P_LV2", "Q":"Q_LV2", "V":"U_LV2", "nameLabel":"BESS", "scaling":0.015432, },]  },
                                                                     ...
                                                                     {'label':'PSCAD_DMAT', 'path':r"PSCAD_sim\result_data\dynamic_smib\20230911-2326_S52515", 'ID': 4, 'timeID':'time(s)', 'timeoffset':-3.0, 
...
#                                                    'cases':['small60','small61','small62','small63','small64','small65','small66','small67','small68','small69'],
                                                    ...
                                                    'plots_for_report': ['PSCAD GPS', 'PSSE GPS', 'Overlays(POC)'], #PV only PSSE
...
#                                                                                             'Angle':                           {'channels':[{'dataset':4, 'name':"phAngSource", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'degrees', 'rank':7, 'yminspan':10.0},
                                                                                             ...
                                                                                             'Inverter State (PPC)':            {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC state', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':9},
                                                                                             ...
                                                                                             'Inverter State (PV)':            {'channels':[{'dataset':4, 'name':"Cpu2SubStt_1", 'leg':'PV state', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':8},
...
#                                                                                            'Inverter State (PPC)':             {'channels':[{'dataset':0, 'name':"FRTACTIVE", 'leg':'PPC state', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'PPC code', 'rank':9},
#
#                                                                                                                                                
...
#                                                                                            'Inverter State (PV)':             {'channels':[{'dataset':0, 'name':"INV1_FRT_STATE", 'leg':'PV state', 'offset':0.0, 'scale':1.0, 'markers':['callout', []]},], 'unit':'inverter code', 'rank':8},
...
##                                                                                              'Reactive Current POC':           {'channels':[{'dataset':4, 'name':"Iq_PLANT", 'leg':'Reactive Current POC', 'offset':0.0, 'scale':1.0},], 'unit':'p.u', 'rank':7, 'yminspan':0.1, 'ymaxlim':2.0, 'yminlim':-2.0 },
##                                                                                             'Angle':                           {'channels':[{'dataset':4, 'name':"phAngSource", 'leg':'Angle at POC', 'offset':0.0, 'scale':1.0},], 'unit':'degrees', 'rank':7, 'yminspan':10.0},
#                                                                                              'Frequency':                      {'channels':[{'dataset':4, 'name':"Hz_POI", 'leg':'Frequency', 'offset':0.0, 'scale':1.0},], 'unit':'Hz', 'rank':9, 'yminspan':5.0},
#                                                                                             'Inverter State (PPC)':            {'channels':[{'dataset':4, 'name':"FrtActive", 'leg':'PPC state', 'offset':0.0, 'scale':1.0},], 'unit':'inverter code', 'rank':7},
#
#
#                                                                                             'Voltage INV':                     {'channels':[{'dataset':4, 'name':"PCU1_V_LV_pu", 'leg':'Voltage PV', 'offset':0.0, 'scale':1.0},
#                                                                                                                                             {'dataset':4, 'name':"PCU2_V_LV_pu", 'leg':'Voltage BESS', 'offset':0.0, 'scale':1.0},], 'unit':'p.u.', 'rank':2, 'yminspan':0.1},
